...
public class InputUtil {
    ...
    public static PetDTO acceptPetDetailsToSave(Scanner scanner) {
        ...
        System.out.println("Press D for domestic pet and W for wild oet.");
        char choice = scanner.next().toUpperCase().charAt(0);
        ...
        if('W' == choice){
            ...
            System.out.println("Enter date of birth of pet (dd-mm-yyy)");
    ...
    private static LocalDate convertStringToDate(String petDateOfBirth) {
        ...
        return LocalDate.parse(petDateOfBirth,formatter);
    }
